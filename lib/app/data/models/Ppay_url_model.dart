import 'package:get_demo/app/data/models/video_quality.dart';
...
class Durl {
  Durl({this.order, this.length, this.size, this.ahead, this.vhead, this.url});

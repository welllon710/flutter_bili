...
class VideoDetailData {
  ...
  VideoDetailData.fromJson(Map<String, dynamic> json) {
    ...
    descV2 =
        json["desc_v2"] == null
            ? []
            : List<DescV2>.from(
              json["desc_v2"]!.map((e) => DescV2.fromJson(e)),
            );
    state = json["state"];
  ...
  Map<String, dynamic> toJson() => {
    ...
    "no_cache": noCache,
    "pages":
        pages == null ? [] : List<dynamic>.from(pages!.map((e) => e.toJson())),
...
class Staff {
  Staff({this.mid, this.title, this.name, this.face, this.vip});
